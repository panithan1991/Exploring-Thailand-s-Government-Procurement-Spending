...
| **02** | [คำถามของโครงการ](#project-question) |
| **03** | [เตรียมข้อมูลก่อนตั้งคำถามเชิง Pattern](#contract-construction) |
| **04** | [โครงการก่อสร้างส่วนใหญ่อยู่ช่วงใด](#budget-band) |
| **05** | [เมื่อขยายดูบริเวณ 500,000 บาท](#near-500k) |
| **06** | [การกระจุกสัมพันธ์กับวิธีจัดซื้อใด และกฎหมายอธิบายอย่างไร](#procurement-method) |
| **07** | [กำหนดกลุ่มศึกษาภายใต้บริบทเดียวกัน](#study-scope) |
| **08** | [นิยาม Pattern สำหรับตรวจสอบ](#patterns) |
...
| **09** | [คำตอบของโครงการและการคัดกรองเหลือ 548 โครงการ](#analysis-results) |
| **10** | [จากรายการคัดกรองสู่การตรวจเอกสาร](#document-review) |
| **11** | [ข้อจำกัดในการตีความ](#limitations) |
...
→ เตรียมข้อมูลและกำหนดหน่วยวิเคราะห์
...
→ Pattern 4: การพึ่งพาผู้รับจ้างในจังหวัด (ไม่พบความสัมพันธ์)
→ ซ้อนทับ Pattern 1 กับ Pattern 2 หรือ Pattern 3
→ เหลือ 548 โครงการสำหรับตรวจสอบลำดับแรก
```
