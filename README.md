...
<p align="center">
  <b>การสำรวจการใช้จ่ายภาครัฐไทยผ่านข้อมูลการจัดซื้อจัดจ้าง</b>
</p>
...
ข้อมูลดังกล่าวเป็นแหล่งข้อมูลหลักของโครงการ โดยนำมาผ่านกระบวนการเตรียมและตรวจสอบข้อมูล การทำความสะอาดและจัดโครงสร้างข้อมูล การวิเคราะห์เชิงสำรวจ ตลอดจนการจัดทำกราฟและภาพประกอบเพื่อสื่อสารผลการวิเคราะห์

<p align="center">
  <b>Raw Data → Data Preprocessing → Data Cleaning → Exploratory Data Analysis (EDA) → Data Visualization</b>
</p>

โครงการนี้มุ่งสำรวจภาพรวมของการจัดซื้อจัดจ้างภาครัฐของประเทศไทยในมิติต่าง ๆ ผ่านการประมวลผล วิเคราะห์ และนำเสนอข้อมูลที่เผยแพร่ต่อสาธารณะ เพื่อให้เห็นโครงสร้าง แนวโน้ม และลักษณะสำคัญของการใช้จ่ายภาครัฐได้ชัดเจนยิ่งขึ้น

> **หมายเหตุ:** ผลการวิเคราะห์ การตีความ และการนำเสนอในโครงการนี้จัดทำขึ้นเพื่อวัตถุประสงค์ด้านการศึกษา โดยเป็นผลงานของผู้จัดทำ และไม่ถือเป็นผลการวิเคราะห์หรือข้อสรุปอย่างเป็นทางการของหน่วยงานเจ้าของข้อมูล
...
ในด้านราคาที่ตกลงซื้อหรือจ้าง พบว่าสัดส่วนเมื่อเทียบกับวงเงินงบประมาณรวมอยู่ในระดับใกล้เคียงกันทั้งสามปี คือ **94.25%**, **94.26%** และ **94.91%** ตามลำดับ
...
> **ประเด็นสำคัญ:** ปี 2567 มีจำนวนโครงการมากที่สุด ขณะที่ปี 2568 มีวงเงินงบประมาณรวมสูงที่สุดในช่วงข้อมูลที่นำมาวิเคราะห์
...
> **หมายเหตุ:** การแบ่งหมวดภารกิจในส่วนนี้เป็นการจัดกลุ่มเชิงวิเคราะห์จากสังกัดและชื่อหน่วยงานด้วยกฎคำสำคัญ เพื่อใช้สำหรับการนำเสนอภาพรวม และ **ไม่ใช่รหัสจำแนกงบประมาณอย่างเป็นทางการ**
...
> **ประเด็นสำคัญ:** ข้อมูลการจัดซื้อจัดจ้างภาครัฐมีช่วงของวงเงินต่อโครงการกว้างมาก ตั้งแต่รายการมูลค่าหลักสิบบาทไปจนถึงโครงการขนาดใหญ่ระดับหมื่นล้านบาท
...
> **ประเด็นสำคัญ:** ประเภทโครงการที่มีจำนวนมากที่สุดไม่จำเป็นต้องเป็นประเภทที่มีวงเงินรวมสูงที่สุด เนื่องจากขนาดและลักษณะของโครงการมีความแตกต่างกัน
...
> **ประเด็นสำคัญ:** กรุงเทพมหานครมีวงเงินรวมสูงกว่าจังหวัดอื่นอย่างเด่นชัด ขณะที่อันดับของจังหวัดในกลุ่มรองลงมามีการเปลี่ยนแปลงในแต่ละปี
...
<details>
<summary><b>🗺️ ปีงบประมาณ 2567</b></summary>
...
<details>
<summary><b>🗺️ ปีงบประมาณ 2568</b></summary>
...
<details>
<summary><b>🗺️ ปีงบประมาณ 2569</b></summary>
...
> **ประเด็นสำคัญ:** รูปแบบการกระจายของวงเงินสะท้อนให้เห็นกลุ่มจังหวัดศูนย์กลางของแต่ละภูมิภาคที่มีวงเงินจัดซื้อจัดจ้างอยู่ในระดับสูงอย่างต่อเนื่อง
...
> **ประเด็นสำคัญ:** จำนวนโครงการมีความสัมพันธ์กับวงเงินรวมในระดับหนึ่ง แต่ไม่สามารถใช้อธิบายระดับวงเงินของแต่ละจังหวัดได้ทั้งหมด เนื่องจากขนาดวงเงินต่อโครงการมีความแตกต่างกัน

> **หมายเหตุ:** กราฟใช้มาตราส่วนลอการิทึม (Log Scale) เพื่อให้สามารถแสดงข้อมูลที่มีช่วงค่ากว้างได้ชัดเจนยิ่งขึ้น
...
> **ประเด็นสำคัญ:** จำนวนโครงการไม่ใช่ปัจจัยเดียวที่กำหนดระดับวงเงินรวมของหน่วยงาน เนื่องจากขนาดและมูลค่าของแต่ละโครงการแตกต่างกัน
...
ค่าเฉลี่ยของวงเงินต่อโครงการจึงสูงกว่าค่ามัธยฐานอย่างชัดเจน โดยปี 2567 มีค่ามัธยฐาน **20,650 บาท** เทียบกับค่าเฉลี่ย **229,021 บาท**
...
> **ประเด็นสำคัญ:** โครงการส่วนใหญ่มีวงเงินไม่สูงมาก แต่มีโครงการขนาดใหญ่จำนวนหนึ่งที่ทำให้ค่าเฉลี่ยของวงเงินต่อโครงการสูงกว่าค่ามัธยฐานอย่างมาก

> **หมายเหตุ:** กราฟใช้มาตราส่วนลอการิทึม (Log Scale) ทั้งแกนวงเงินและแกนจำนวนโครงการ เพื่อให้เห็นรูปแบบการกระจายของข้อมูลได้ชัดเจนยิ่งขึ้น
