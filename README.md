...
โครงการนี้จัดทำขึ้นเพื่อศึกษาและสำรวจภาพรวมของ **ข้อมูลการจัดซื้อจัดจ้างภาครัฐของประเทศไทย** ในมิติต่าง ๆ โดยนำข้อมูลที่เผยแพร่ต่อสาธารณะมาผ่านกระบวนการเตรียมข้อมูล การตรวจสอบและทำความสะอาดข้อมูล การวิเคราะห์เชิงสำรวจ ตลอดจนการจัดทำกราฟและภาพประกอบเพื่อให้สามารถมองเห็นแนวโน้ม โครงสร้าง และลักษณะสำคัญของข้อมูลได้ชัดเจนยิ่งขึ้น
...
> [!NOTE]
> **หมายเหตุ**  
> ข้อมูลปีงบประมาณ พ.ศ. 2569 เป็นข้อมูล ณ วันที่ **30 กรกฎาคม 2569** จึงยังไม่ครอบคลุมตลอดทั้งปีงบประมาณ โดยหมายเหตุนี้ใช้กับกราฟและผลการวิเคราะห์ของปีงบประมาณ 2569 ทั้งหมดในโครงการ
...
จากการสำรวจข้อมูลการจัดซื้อจัดจ้างภาครัฐในช่วงปีงบประมาณ พ.ศ. 2567–2569 สามารถสรุปประเด็นสำคัญในภาพรวมได้ดังนี้

- ปีงบประมาณ **2567** มีจำนวนโครงการสูงที่สุด จำนวน **5,428,289 โครงการ**
...
> [!NOTE]
> **หมายเหตุ**  
> การเปรียบเทียบข้อมูลปีงบประมาณ 2569 กับปี 2567 และ 2568 ควรพิจารณาร่วมกับข้อจำกัดด้านช่วงเวลาของข้อมูล เนื่องจากข้อมูลปี 2569 ยังไม่สิ้นสุดรอบปีงบประมาณ
...
> ผลการวิเคราะห์ การตีความ และการนำเสนอภายในโครงการนี้จัดทำขึ้นเพื่อวัตถุประสงค์ด้านการศึกษาและการวิเคราะห์ข้อมูล โดยเป็นผลงานของผู้จัดทำ และไม่ถือเป็นผลการวิเคราะห์หรือข้อสรุปอย่างเป็นทางการของหน่วยงานเจ้าของข้อมูล
...
> [!NOTE]
> **หมายเหตุ**  
> ปีงบประมาณ 2567 มีจำนวนโครงการมากที่สุด ขณะที่ปีงบประมาณ 2568 มีวงเงินงบประมาณรวมสูงที่สุดในช่วงข้อมูลที่นำมาศึกษา ส่วนข้อมูลปี 2569 ยังไม่ครบถ้วนตลอดทั้งปีงบประมาณ จึงควรพิจารณาในบริบทของช่วงเวลาที่จัดเก็บข้อมูล
...
> [!NOTE]
> **หมายเหตุ**  
> ข้อมูลสะท้อนให้เห็นว่าการจัดซื้อจัดจ้างภาครัฐมีช่วงของวงเงินต่อโครงการที่กว้างมาก ตั้งแต่รายการจัดซื้อขนาดเล็กมูลค่าหลักสิบบาท ไปจนถึงโครงการขนาดใหญ่ที่มีวงเงินระดับหมื่นล้านบาท
...
> [!NOTE]
> **หมายเหตุ**  
> ประเภทโครงการที่มีจำนวนรายการมากที่สุดไม่จำเป็นต้องเป็นประเภทที่มีวงเงินรวมสูงที่สุด เนื่องจากมูลค่าและขนาดของแต่ละโครงการมีความแตกต่างกัน
...
ในขณะที่ **สมุทรสงคราม** มีวงเงินรวมอยู่ในระดับต่ำที่สุดของทั้งสามปี โดยมีวงเงินประมาณ **2.17 พันล้านบาท**, **1.99 พันล้านบาท** และ **2.12 พันล้านบาท** ตามลำดับ

> [!NOTE]
> **หมายเหตุ**  
> กรุงเทพมหานครมีวงเงินจัดซื้อจัดจ้างรวมสูงกว่าจังหวัดอื่นอย่างเด่นชัดตลอดทั้งสามปี ขณะที่อันดับของจังหวัดในกลุ่มรองลงมามีการเปลี่ยนแปลงตามลักษณะและขนาดของโครงการในแต่ละปี
...
> [!NOTE]
> **หมายเหตุ**  
> รูปแบบการกระจายของวงเงินสะท้อนให้เห็นว่าจังหวัดที่เป็นศูนย์กลางทางเศรษฐกิจ การบริหาร และการให้บริการในแต่ละภูมิภาค มีแนวโน้มได้รับวงเงินจัดซื้อจัดจ้างในระดับสูงอย่างต่อเนื่อง
...
การกระจายของข้อมูลบนกราฟแบบ Log–Log มีแนวโน้มจากบริเวณด้านล่างซ้ายไปยังด้านบนขวา สะท้อนให้เห็นถึงความสัมพันธ์เชิงบวกระหว่างจำนวนโครงการและวงเงินรวม
...
> [!NOTE]
> **หมายเหตุ**  
> จำนวนโครงการมีความสัมพันธ์กับวงเงินรวมในระดับหนึ่ง แต่ขนาดและมูลค่าของแต่ละโครงการยังเป็นปัจจัยสำคัญที่ทำให้จังหวัดที่มีจำนวนโครงการใกล้เคียงกันอาจมีวงเงินรวมแตกต่างกันได้
...
> [!NOTE]
> **หมายเหตุ**  
> จำนวนโครงการไม่ใช่ปัจจัยเพียงอย่างเดียวที่กำหนดระดับวงเงินรวมของหน่วยงาน เนื่องจากลักษณะ ภารกิจ และมูลค่าของโครงการแต่ละประเภทมีความแตกต่างกัน
...
การที่ค่าเฉลี่ยสูงกว่าค่ามัธยฐานอย่างชัดเจนสะท้อนให้เห็นว่า การกระจายของวงเงินมีลักษณะ **เบ้ไปทางขวา (Right-skewed)** กล่าวคือ มีโครงการที่มีวงเงินสูงจำนวนหนึ่งซึ่งส่งผลให้ค่าเฉลี่ยเพิ่มสูงขึ้น แม้ว่าโครงการส่วนใหญ่จะมีวงเงินอยู่ในระดับต่ำกว่าค่าเฉลี่ยก็ตาม
...
> [!NOTE]
> **หมายเหตุ**  
> โครงการส่วนใหญ่มีวงเงินต่อโครงการไม่สูงมาก แต่มีโครงการขนาดใหญ่จำนวนหนึ่งที่ส่งผลให้ค่าเฉลี่ยของวงเงินต่อโครงการสูงกว่าค่ามัธยฐานอย่างชัดเจน
